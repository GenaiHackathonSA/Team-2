...
const get_transactions = (
  ...
  return axios.get(API_BASE_URL + "/transaction/getByUser", {
    headers: AuthService.authHeader(),
    params: {
      email: email,
...
const get_single_transaction = (id) => {
  return axios.get(API_BASE_URL + "/transaction/getById", {
    headers: AuthService.authHeader(),
    params: {
      id: id,
    },
...
const update_transaction = (
  ...
  return axios.put(
    API_BASE_URL + "/transaction/update",
    {
      userEmail: email,
      categoryId: categoryId,
      description: descripiton,
...
const settingsResetPassword = async (email, oldPassword, newpassword) => {
  return await axios.post(
    API_BASE_URL + "/user/settings/changePassword",
    {
      email: email,
...
const getTotalIncomeOrExpense = async (
  userId,
  transactionTypeId,
  month,
  year
) => {
  return axios.get(API_BASE_URL + "/report/getTotalIncomeOrExpense", {
    headers: AuthService.authHeader(),
    params: {
      userId: userId,
...
const getTotalNoOfTransactions = async (userId, month, year) => {
  return axios.get(API_BASE_URL + "/report/getTotalNoOfTransactions", {
    headers: AuthService.authHeader(),
    params: {
      userId: userId,
      month: month,
...
const getTotalByCategory = async (email, categoryId, month, year) => {
  return await axios.get(API_BASE_URL + "/report/getTotalByCategory", {
    headers: AuthService.authHeader(),
    params: {
      email: email,
      categoryId: categoryId,
...
const getMonthlySummary = async (email) => {
  return await axios.get(API_BASE_URL + "/report/getMonthlySummaryByUser", {
    headers: AuthService.authHeader(),
    params: {
      email: email,
    },
...
const getBudget = async (month, year) => {
  return await axios.get(API_BASE_URL + "/budget/get", {
    headers: AuthService.authHeader(),
    params: {
...
const getProfileImg = async () => {
  return await axios.get(API_BASE_URL + "/user/settings/profileImg", {
    headers: AuthService.authHeader(),
    params: {
...
const removeProfileImg = async () => {
  return await axios.delete(API_BASE_URL + "/user/settings/profileImg", {
    headers: AuthService.authHeader(),
    params: {
      email: AuthService.getCurrentUser().email,
    },
...
const getSavedTransactions = () => {
  return axios.get(API_BASE_URL + "/saved/user", {
    headers: AuthService.authHeader(),
    params: {
...
const getSavedTransactionById = (id) => {
  return axios.get(API_BASE_URL + "/saved/", {
    headers: AuthService.authHeader(),
    params: {
      id: id,
    },
...
const deleteSavedTransaction = (id) => {
  return axios.delete(API_BASE_URL + "/saved/", {
    headers: AuthService.authHeader(),
    params: {
      id: id,
    },
...
const addSavedTransaction = (id) => {
  return axios.get(API_BASE_URL + "/saved/add", {
    headers: AuthService.authHeader(),
    params: {
      id: id,
    },
...
const skipSavedTransaction = (id) => {
  return axios.get(API_BASE_URL + "/saved/skip", {
    headers: AuthService.authHeader(),
    params: {
      id: id,
    },
